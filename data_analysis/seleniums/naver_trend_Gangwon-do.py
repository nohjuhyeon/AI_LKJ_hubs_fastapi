...
collection = database['festival_Gangwon-do']
...
for find_card in find_cards :
    ...
    if len(find_card.find_elements(by=By.CSS_SELECTOR, value='p'))==5:
        date = find_card.find_element(by=By.CSS_SELECTOR, value="p:nth-child(6)").text
    elif span_in_address :
        date = find_card.find_element(by=By.CSS_SELECTOR, value="p:nth-child(7)").text
    else:
        date = find_card.find_element(by=By.CSS_SELECTOR, value='p:nth-child(5)').text
