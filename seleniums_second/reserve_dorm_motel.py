...
motel_checkbox = browser.find_element(By.CSS_SELECTOR, "#filter_group_ht_id_\:rs\: > div:nth-child(8) > label > span.ef785aa7f4 > span > svg")
motel_checkbox.click()
...
while True:
    ...
    for element in elements:
        motel_image = element.find_element(By.CSS_SELECTOR, 'img.f9671d49b1').get_attribute('src')
        motel_name = element.find_element(By.CSS_SELECTOR, 'div.f6431b446c.a15b38c233').text
        motel_address = element.find_element(By.CSS_SELECTOR, 'span.aee5343fdb.def9bc142a').text
        motel_price = element.find_element(By.CSS_SELECTOR, 'span.f6431b446c.fbfd7c1165.e84eb96b1f').text
        collection.insert_one({
            "dorm_image": motel_image,
            "dorm_name": motel_name,
            "dorm_address": motel_address,
            "dorm_price": motel_price,
            "dorm_cate": "motel"
        })
    try:
