...
hotel_checkbox = browser.find_element(By.CSS_SELECTOR, "#filter_group_popular_\:rj\: > div:nth-child(3) > label > span.ef785aa7f4 > span > svg")
...
while True:
    ...
    for element in elements:
        hotel_image = element.find_element(By.CSS_SELECTOR, 'img.f9671d49b1').get_attribute('src')
        hotel_name = element.find_element(By.CSS_SELECTOR, 'div.f6431b446c.a15b38c233').text
